export default {
  ...
  'sessions.count': '{m} projects · {n} sessions',
  ...
  'settings.display.legacySessionList': 'Use legacy session list layout',
  'settings.display.legacySessionList.desc': 'Restore session and project counts, collapsible machine rows, and inline machine health.',
